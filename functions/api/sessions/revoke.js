import { json, readJson, requireAuth, revokeSessionBySid, auditEvent, sha256Base64 } from "../../_lib.js";
...
export async function onRequestPost({ request, env }){
  ...
  if(!row || String(row.user_id || "") !== String(a.uid || "")){
    return json(404, "not_found", { message:"session_not_found" });
  }

  await revokeSessionBySid(env, sid, "user_revoke_session");
