export default function(Orland){
  ...
  async function load(){ return await Orland.api("/api/blogspot/pages?maxResults=20"); }
  ...
  return {
    ...
    async mount(host){
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <div class="text-sm text-slate-500">Read-only static pages.</div>
            </div>
      ...
      async function render(){
        ...
        if(!items.length){
          box.innerHTML = `<div class="text-xs text-slate-500">No pages.</div>`;
          return;
        }
